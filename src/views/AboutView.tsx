...
export default function AboutView() {
  ...
  const canSend = useMemo(() => {
    ...
    if (!e || !m) return false;
    // simple email check (good enough for UI; server decides anyway)
  ...
  // simple responsive switch based on window width is overkill; keep it robust:
  // use CSS grid collapse with a media query via inline <style>.
  return (
